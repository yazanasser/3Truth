(() => {
  ...
  const AUTH_MODAL_HTML = `
    ...
    <div id="auth-card" dir="auto" class="relative w-full max-w-2xl mx-auto p-10 md:p-16 rounded-[24px] shadow-2xl bg-[#030305]/95 border border-white/10 backdrop-blur-xl animate-modal-content">
      <div class="text-center mt-12 mb-10">
        ...
        <p class="text-lg md:text-2xl font-medium text-white/90 leading-relaxed stagger-anim delay-2" id="auth-title" data-i18n="auth.modalTitle">
      ...
      <form id="signin-form" class="space-y-12" onsubmit="event.preventDefault();">
        <div class="space-y-4 stagger-anim delay-3" id="email-section">
          <label for="signin-email" class="text-sm font-semibold text-gray-400 ml-2 flex items-center gap-2" data-i18n="contact.email">
        ...
        <div class="space-y-4 hidden stagger-anim delay-3" id="otp-section">
          <div class="flex justify-between items-center px-2">
            <label for="signin-otp" class="text-sm font-semibold text-gray-400 flex items-center gap-2" data-i18n="auth.verificationCode">
            ...
            <button type="button" id="resend-btn"
              ...
              disabled data-i18n="auth.resendIn" data-i18n-options='{"seconds": 60}'>Resend in 60s</button>
          </div>
        ...
        <div class="pt-4 stagger-anim delay-4">
          <button type="submit" id="submit-btn"
            ...
            <span id="submit-text" data-i18n="auth.sendCode">Send Code</span>
          </button>
          <p class="text-gray-500 font-bold uppercase tracking-[0.2em] text-xs text-center mt-8" id="auth-subtitle" data-i18n="auth.verifyEmail">
      ...
      <div class="mt-20 text-center stagger-anim delay-5">
        <p class="text-gray-500 font-bold uppercase tracking-widest text-xs" data-i18n="auth.securedBy">
  ...
  function openAuthModal(e) {
    ...
    // Force translation immediately to prevent language mixing
    if (window._3truthI18n && typeof window._3truthI18n.translatePage === "function") {
      window._3truthI18n.translatePage();
    }
  }
