(() => {
  ...
  const EXACT = new Map(
    Object.entries({
      ...
      "Unescapable intelligence. Drop your content below and let the neural engine dissect the truth.":
        "ذكاء لا يمكن خداعه. ضع المحتوى بالأسفل ودع المحرك العصبي يحلل الحقيقة.",
      TEXT: "نص",
      IMAGE: "صورة",
      VIDEO: "فيديو",
      ...
      "Stylometry & Language Rhythm": "الأسلوبية وإيقاع اللغة",
      "Paste human, AI, humanized AI, academic, business, Arabic, or mixed-language text for structure and writing-pattern analysis.":
        "ألصق نصا بشريا أو نص ذكاء اصطناعي أو نصا معدلا أو أكاديميا أو تجاريا أو عربيا أو مختلطا لتحليل البنية وأنماط الكتابة.",
      STYLE: "الأسلوب",
      BURSTINESS: "التفاوت",
      PHRASES: "العبارات",
      ARABIC: "العربية",
      ...
      "Paste text to scan rhythm, phrases, burstiness, structure, and humanized-AI signals.":
        "ألصق النص لفحص الإيقاع والعبارات والتفاوت والبنية وإشارات النص المعدل.",
      "SCANNING TEXT": "جار فحص النص",
      "Reading stylometry, sentence cadence, phrase density, and multilingual signals...":
        "يتم قراءة الأسلوبية وإيقاع الجمل وكثافة العبارات والإشارات متعددة اللغات...",
      "IMAGE FORENSIC MODE": "وضع تحليل الصور",
      "Pixel & Metadata Inspection": "فحص البكسلات والبيانات الوصفية",
      "Upload a photo, render, scan, screenshot, RAW file, or edited image for camera provenance and pixel artifact analysis.":
        "ارفع صورة أو لقطة شاشة أو ملف RAW أو صورة معدلة لتحليل مصدر الكاميرا وآثار البكسلات.",
      "Checks camera provenance, EXIF traces, compression patterns, edits, fake texture, and AI rendering artifacts.":
        "يفحص مصدر الكاميرا وآثار EXIF وأنماط الضغط والتعديلات والملمس المزيف وآثار التوليد بالذكاء الاصطناعي.",
      EXIF: "EXIF",
      PIXELS: "البكسلات",
      ...
      "JPG, PNG, WEBP, HEIC, RAW, screenshots, edited photos":
        "JPG و PNG و WEBP و HEIC و RAW ولقطات الشاشة والصور المعدلة",
      "IMAGE FORENSICS READY": "تحليل الصور جاهز",
      "Upload one image to scan pixels, metadata, artifacts, and edit traces.":
        "ارفع صورة واحدة لفحص البكسلات والبيانات الوصفية والآثار والتعديلات.",
      "SCANNING IMAGE": "جار فحص الصورة",
      "Inspecting metadata, pixel structure, texture, and compression...":
        "يتم فحص البيانات الوصفية وبنية البكسلات والملمس والضغط...",
      ...
      "Checks frame-to-frame motion, temporal artifacts, scene continuity, codec traces, and generated-video instability.":
        "يفحص الحركة بين الإطارات والآثار الزمنية واستمرارية المشهد وآثار الترميز وعدم استقرار الفيديو المولد.",
      FRAMES: "الإطارات",
      MOTION: "الحركة",
      CODEC: "الترميز",
      TEMPORAL: "زمني",
      "SCAN VIDEO FRAMES": "فحص إطارات الفيديو",
      "Drop a video for temporal frame analysis":
        "أسقط فيديو لتحليل الإطارات زمنيا",
      "MP4, MOV, WEBM, MKV, AVI, phone clips, screen recordings":
        "MP4 و MOV و WEBM و MKV و AVI ومقاطع الهاتف وتسجيلات الشاشة",
      "VIDEO TIMELINE READY": "تحليل خط الفيديو جاهز",
      "Upload one clip to scan frame consistency, motion, and encoded artifacts.":
        "ارفع مقطعا واحدا لفحص اتساق الإطارات والحركة وآثار الترميز.",
      "SCANNING VIDEO": "جار فحص الفيديو",
      "Sampling frames, motion signals, timeline continuity, and codec traces...":
        "يتم أخذ عينات من الإطارات وإشارات الحركة واستمرارية الخط الزمني وآثار الترميز...",
      ...
      "No human-written segments identified in the source.":
        "لم يتم تحديد مقاطع مكتوبة بشريا في المصدر.",
      "No synthetic/AI-generated segments identified.":
        "لم يتم تحديد مقاطع مولدة بالذكاء الاصطناعي.",
      "No artificial/AI-generated segments identified.":
        "لم يتم تحديد مقاطع مولدة آليا.",
      "No organic/human-written segments identified.":
        "لم يتم تحديد مقاطع بشرية.",
      ...
      "Please enter at least 50 characters for meaningful analysis.":
        "يرجى إدخال 50 حرفا على الأقل للحصول على تحليل مفيد.",
      "Please select a file to analyze.": "يرجى اختيار ملف لتحليله.",
      "You must be signed in to scan. Redirecting...":
        "يجب تسجيل الدخول لإجراء الفحص. سيتم تحويلك...",
      ...
      "Please select PDF or Word upload mode first.":
        "يرجى اختيار وضع رفع PDF أو Word أولا.",
      "Invalid file. Please upload a PDF document.":
        "ملف غير صالح. يرجى رفع مستند PDF.",
      "Invalid file. Please upload a readable text, code, data, PDF, or Word document.":
        "ملف غير صالح. يرجى رفع نص أو كود أو بيانات أو PDF أو Word قابل للقراءة.",
      "No readable text could be extracted from this document.":
        "تعذر استخراج نص قابل للقراءة من هذا المستند.",
      "Failed to extract text from document. It might be corrupted or protected.":
        "فشل استخراج النص من المستند. قد يكون تالفا أو محميا.",
      "Please upload a readable text, code, data, PDF, or Word file.":
        "يرجى رفع ملف نص أو كود أو بيانات أو PDF أو Word قابل للقراءة.",
      "UPLOAD FILE": "رفع ملف",
      ...
      "Beta v is open now: Text, Image, and Video detectors are free and unlimited for every signed-in user. Paid subscriptions are locked until production launch.":
        "الإصدار التجريبي متاح الآن: أدوات كشف النصوص والصور والفيديو مجانية وغير محدودة لكل مستخدم مسجل. الاشتراكات المدفوعة مقفلة حتى إطلاق النسخة النهائية.",
      ...
      "Standard parsers fail against modern humanizers. We don't read words. We calculate the multi-dimensional semantic vector distance between tokens. If a machine generated it, the math will betray it.":
        "تفشل المحللات القياسية أمام أدوات التأنيس الحديثة. نحن لا نقرأ الكلمات. نحن نحسب المسافة المتجهية الدلالية متعددة الأبعاد بين الرموز. إذا كان الجهاز هو من أنشأها، فإن الرياضيات ستكشف ذلك.",
      ...
      "let entropy = computeEntropy(targetData);":
        "دع الانتروبيا = حساب_الانتروبيا(البيانات_المستهدفة);",
      "let burst = analyzeBurstiness(targetData);":
        "دع التفاوت = تحليل_التفاوت(البيانات_المستهدفة);",
      "if (entropy < 0.34 && burst < 0.18) {":
        "إذا (الانتروبيا < 0.34 && التفاوت < 0.18) {",
      'executeThreatResponse("SYNTHETIC_ORIGIN");':
        'تنفيذ_استجابة_التهديد("مصدر_اصطناعي");',
      "} else {": "} وإلا {",
      'return "ORGANIC_ORIGIN";': 'إرجاع "مصدر_عضوي";',
      "> THREAT DETECTED. SYNTHETIC ORIGIN CONFIRMED.":
        "> تم اكتشاف تهديد. تم تأكيد المصدر الاصطناعي.",
      ">> SYSTEM CAPABILITIES": ">> قدرات النظام",
      "> Dissects semantic structures at the token level, finding the probabilistic gaps machines mathematically depend on.":
        "> يحلل الهياكل الدلالية على مستوى الرمز، ويكتشف الفجوات الاحتمالية التي تعتمد عليها الآلات رياضياً.",
      "> Engineered for absolute speed. Processing 10,000 tokens in <200ms.":
        "> مصمم للسرعة المطلقة. معالجة 10,000 رمز في أقل من 200 مللي ثانية.",
      "> Complete isolation. Zero data retention. Military-grade privacy.":
        "> عزل كامل. صفر احتفاظ بالبيانات. خصوصية بمستوى عسكري.",
      "> Seamlessly pivot between Text, Code, and Hex analysis in one unified intelligence dashboard.":
        "> تنقل بسلاسة بين تحليل النص والكود والنظام السداسي العشري في لوحة معلومات ذكية موحدة.",
      "> PHASE 01: INGESTION": "> المرحلة 01: الاستيعاب",
      "Input target data vector. Accepts raw text, documents, or direct API streams. Capacity up to 500,000 parameters per cycle.":
        "أدخل متجه البيانات المستهدفة. يقبل النص الRAW أو المستندات أو تدفقات API المباشرة. سعة تصل إلى 500,000 معلمة لكل دورة.",
      "> PHASE 02: ANALYSIS": "> المرحلة 02: التحليل",
      "Running 47 parallel heuristic models. Cross-referencing token entropy and structural repetition against known LLM architectures.":
        "تشغيل 47 نموذجًا استكشافيًا متوازيًا. مطابقة انتروبيا الرموز والتكرار الهيكلي مع بنيات نماذج اللغة الكبيرة (LLM) المعروفة.",
      "> PHASE 03: EXECUTION": "> المرحلة 03: التنفيذ",
      "Generate absolute forensic confidence score. Heatmap pinpointing exact synthetic injection points down to the character.":
        "توليد درجة ثقة جنائية مطلقة. خريطة حرارية تحدد بدقة نقاط الحقن الاصطناعي حتى مستوى الحرف.",
      "> AWAITING COMMAND. INITIATE PROTOCOL TO BEGIN FORENSIC SCAN.":
        "> في انتظار الأمر. ابدأ البروتوكول لبدء الفحص الجنائي.",
      "3TRUTH GLOBAL INTELLIGENCE © 2026. ALL SYSTEMS CLASSIFIED.":
        "3TRUTH للذكاء العالمي © 2026. جميع الأنظمة سرية.",
      "PROVENANCE_SHELL_v1.0.4_STABLE": "صدفة_المصدر_الإصدار_1.0.4_مستقر",
      "ENCODING: UTF-8": "الترميز: UTF-8",
      "Everything in the beta is free right now. Text, image, and video detection are open while paid plans stay locked until production launch.":
        "كل شيء في النسخة التجريبية مجاني الآن. فحص النصوص والصور والفيديو متاح بينما تظل الخطط المدفوعة مقفلة حتى إطلاق النسخة النهائية.",
      "Basic is the only visible plan during beta. It includes the full beta experience for text, image, and video detection so users can test the platform freely before subscriptions launch.":
        "الخطة الأساسية هي الخطة الوحيدة المرئية أثناء الإصدار التجريبي. تتضمن تجربة بيتا الكاملة لفحص النصوص والصور والفيديو حتى يتمكن المستخدمون من اختبار المنصة بحرية قبل إطلاق الاشتراكات.",
      ...
      "Reports and forensic signals included":
        "التقارير والإشارات الجنائية متضمنة",
      "Paid subscriptions hidden until launch":
        "الاشتراكات المدفوعة مخفية حتى الإطلاق",
      ...
      "All core detectors are free and unlimited while the platform is in beta.":
        "كل الكواشف الأساسية مجانية وغير محدودة أثناء فترة البيتا.",
      ...
      "Paid subscriptions are locked during beta":
        "الاشتراكات المدفوعة مقفلة أثناء البيتا",
      ...
      "Thank you for visiting! Please sign in to continue.":
        "شكراً لزيارتك! يرجى تسجيل الدخول للمتابعة.",
      ...
      "Too many attempts. Please try again later.":
        "محاولات كثيرة جدا. يرجى المحاولة لاحقا.",
      ...
      "We are actively working on bringing you this content. Please check back soon.":
        "نعمل حاليا على تجهيز هذا المحتوى. يرجى العودة لاحقا.",
      "Everything you need to know about AI Detector.":
        "كل ما تحتاج معرفته عن كاشف الذكاء الاصطناعي.",
      "Empowering trust in the digital age.": "تعزيز الثقة في العصر الرقمي.",
      Careers: "الوظائف",
      "Join our mission to build a more transparent web.":
        "انضم إلى مهمتنا لبناء ويب أكثر شفافية.",
      Blog: "المدونة",
      "Insights and updates from the AI Detector team.":
        "رؤى وتحديثات من فريق كاشف الذكاء الاصطناعي.",
      ...
      "— Sign up at": "— سجّل في",
      "using email or Google OAuth.":
        "باستخدام البريد الإلكتروني أو تسجيل الدخول عبر Google.",
      "2. Beta Access": "2. وصول بيتا",
      "— During beta, every signed-in user gets free unlimited scans across Text, Image, and Video detectors. Paid subscriptions are locked until production launch.":
        "— أثناء البيتا، يحصل كل مستخدم مسجل على فحوصات مجانية وغير محدودة عبر كواشف النصوص والصور والفيديو. الاشتراكات المدفوعة مقفلة حتى إطلاق النسخة النهائية.",
      "3. Start Scanning": "3. ابدأ الفحص",
      "— Navigate to the Detector page, select your mode (Text, Image, or Video), paste or upload your content, and hit Analyze.":
        "— انتقل إلى صفحة الكاشف، اختر الوضع (نص أو صورة أو فيديو)، ثم الصق أو ارفع المحتوى واضغط تحليل.",
      "Detection Modes": "أوضاع الكشف",
      "Text Detector": "كاشف النصوص",
      "Image Detector": "كاشف الصور",
      "Video Detector": "كاشف الفيديو",
      "Analyzes semantic patterns, perplexity scores, and token entropy to identify AI-generated text from models like GPT-4, Claude, Gemini, and LLaMA.":
        "يحلل الأنماط الدلالية ودرجات التعقيد وانتروبيا الرموز لتحديد النصوص المولدة بالذكاء الاصطناعي من نماذج مثل GPT-4 وClaude وGemini وLLaMA.",
      "Detects deepfake images, AI-generated art, and manipulated photos using pixel-level forensic analysis and GAN fingerprint detection.":
        "يكشف الصور المزيفة والفن المولد بالذكاء الاصطناعي والصور المعدلة باستخدام تحليل جنائي على مستوى البكسل وكشف بصمات GAN.",
      "Frame-by-frame temporal analysis to detect synthetic video content, face swaps, and AI-generated motion sequences.":
        "تحليل زمني إطارا بإطار لكشف الفيديوهات الاصطناعية وتبديل الوجوه وتسلسلات الحركة المولدة بالذكاء الاصطناعي.",
      "Understanding Results": "فهم النتائج",
      "The detector outputs a forensic confidence score from 0% to 100%:":
        "يعرض الكاشف درجة ثقة جنائية من 0% إلى 100%:",
      "— Likely human-written / organic content": "— غالبا محتوى بشري أو طبيعي",
      "— Mixed signals, possibly AI-assisted":
        "— إشارات مختلطة، وربما بمساعدة الذكاء الاصطناعي",
      "— High confidence synthetic / AI-generated":
        "— ثقة عالية بأنه محتوى اصطناعي أو مولد بالذكاء الاصطناعي",
      ...
      "— Ensure your file is within size limits and a supported format.":
        "— تأكد أن الملف ضمن حدود الحجم وبصيغة مدعومة.",
      "Slow Processing": "المعالجة بطيئة",
      "— Video analysis may take up to 60 seconds for large files. Text and image analysis typically completes in under 5 seconds.":
        "— قد يستغرق تحليل الفيديو حتى 60 ثانية للملفات الكبيرة. عادة يكتمل تحليل النصوص والصور خلال أقل من 5 ثوان.",
      "— Scan quotas are disabled during beta. If scanning is blocked, refresh the page and sign in again.":
        "— حدود الفحص معطلة أثناء البيتا. إذا تم حظر الفحص، حدّث الصفحة وسجّل الدخول مرة أخرى.",
      "Our Mission": "مهمتنا",
      "3truth was founded by a collective of cybersecurity experts, AI researchers, and data scientists who recognized the growing threat of undetectable synthetic media. In an era where deepfakes and AI-generated misinformation can disrupt markets and damage reputations, we built the ultimate defense mechanism.":
        "تأسست 3truth على يد مجموعة من خبراء الأمن السيبراني وباحثي الذكاء الاصطناعي وعلماء البيانات الذين أدركوا الخطر المتزايد للمحتوى الاصطناعي صعب الكشف. في عصر يمكن فيه للتزييف العميق والمعلومات المضللة المولدة بالذكاء الاصطناعي أن تؤثر في الأسواق وتضر بالسمعة، بنينا آلية دفاع قوية.",
      "What We Do": "ماذا نفعل",
      "We establish a digital perimeter of truth. By continuously training our models against the latest generative adversarial networks (GANs) and large language models (LLMs), 3truth stays one step ahead of synthetic content generation. Our platform processes millions of scans daily, protecting journalists, educators, legal teams, and enterprises from misinformation.":
        "ننشئ محيطا رقميا للحقيقة. من خلال تدريب نماذجنا باستمرار ضد أحدث الشبكات التوليدية GANs ونماذج اللغة الكبيرة LLMs، تبقى 3truth متقدمة بخطوة على توليد المحتوى الاصطناعي. تعالج منصتنا ملايين الفحوصات يوميا لحماية الصحفيين والمعلمين والفرق القانونية والمؤسسات من التضليل.",
      "Our Technology": "تقنيتنا",
      "Neural Fingerprinting": "البصمة العصبية",
      "Our proprietary models detect subtle statistical signatures left by AI generators — patterns invisible to the human eye but unmistakable to our algorithms.":
        "تكشف نماذجنا الخاصة البصمات الإحصائية الدقيقة التي تتركها مولدات الذكاء الاصطناعي — وهي أنماط لا تراها العين البشرية لكنها واضحة لخوارزمياتنا.",
      "Adversarial Training": "التدريب الخصومي",
      "We continuously red-team our own models against the newest generators, ensuring our detection stays ahead of the generation curve.":
        "نختبر نماذجنا باستمرار ضد أحدث المولدات لضمان بقاء قدرات الكشف متقدمة على منحنى التوليد.",
      "Multi-Modal Analysis": "تحليل متعدد الوسائط",
      "Text, image, and video analysis run on separate specialized neural networks optimized for each content type.":
        "تعمل تحليلات النصوص والصور والفيديو على شبكات عصبية متخصصة ومنفصلة ومحسنة لكل نوع محتوى.",
      "Real-Time Processing": "معالجة فورية",
      "Enterprise-grade infrastructure delivers sub-second analysis for text and images, with 99.99% uptime SLA.":
        "توفر بنية تحتية بمستوى المؤسسات تحليلا للنصوص والصور في أقل من ثانية، مع اتفاقية توفر 99.99%.",
      "Global Presence": "حضور عالمي",
      "Our team operates globally with research hubs in":
        "يعمل فريقنا عالميا مع مراكز بحث في",
      "San Francisco": "سان فرانسيسكو",
      London: "لندن",
      ". We are dedicated to pushing the boundaries of forensic analysis and providing our clients with absolute confidence in the media they consume and distribute.":
        ". نحن ملتزمون بتوسيع حدود التحليل الجنائي وتوفير ثقة كاملة لعملائنا في الوسائط التي يستهلكونها ويوزعونها.",
      ...
      "Whether you are looking for enterprise integration, encountering technical issues, or just want to learn more about our forensic technology, our team is here to help.":
        "سواء كنت تبحث عن تكامل مؤسسي أو تواجه مشكلات تقنية أو تريد معرفة المزيد عن تقنيتنا الجنائية، فريقنا هنا لمساعدتك.",
      ...
      "24/7 priority support with dedicated account manager. Average response time: <15 minutes.":
        "دعم أولوية على مدار الساعة مع مدير حساب مخصص. متوسط وقت الاستجابة: أقل من 15 دقيقة.",
      "Standard Support": "الدعم القياسي",
      "Monday–Friday, 9 AM – 6 PM PST. We aim to respond to all tickets within 2 hours.":
        "من الاثنين إلى الجمعة، من 9 صباحا إلى 6 مساء بتوقيت المحيط الهادئ. نهدف للرد على جميع التذاكر خلال ساعتين.",
    }),
  );
  ...
  function isArabicMode() {
    ...
    return (
      values.some(
        (value) =>
          value === "ar" || value.startsWith("ar-") || value === "arabic",
      ) ||
      (window._3truthI18n &&
        window._3truthI18n.isArabic &&
        window._3truthI18n.isArabic())
    );
  }
  ...
  function restore(value, tokens) {
    return tokens.reduce(
      (text, token, index) => text.replaceAll(`__I18N_TOKEN_${index}__`, token),
      value,
    );
  }
  ...
  function translateString(value) {
    ...
    const exact =
      ...
      EXACT.get(normalized.toUpperCase());
  ...
  function translateAttributes(root) {
    ...
    root
      .querySelectorAll(
        'button[value], input[type="button"][value], input[type="submit"][value], input[type="reset"][value]',
      )
      .forEach((element) => {
        const source = sourceForAttr(element, "value");
        const next = isArabicMode() ? translateString(source) : source;
        if (element.getAttribute("value") !== next)
  ...
  function sanitizeContactEmails(root = document.body) {
    ...
    root.querySelectorAll('a[href^="mailto:"]').forEach((link) => {
      ...
      if (normalize(link.textContent) !== CONTACT_EMAIL)
    ...
    while (walker.nextNode()) nodes.push(walker.currentNode);
    nodes.forEach((node) => {
      node.nodeValue = node.nodeValue.replace(emailPattern, (email) =>
        email.toLowerCase() === CONTACT_EMAIL ? email : CONTACT_EMAIL,
      );
    });
  }
